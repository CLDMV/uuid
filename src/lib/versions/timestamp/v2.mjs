 ...
 *	@Filename: /src/lib/versions/timestamp/v2.mjs
 *	@Date: 2025-12-30T17:00:08-08:00 (1767142808)
 *	@Author: Nate Corcoran <CLDMV>
 *	@Email: <Shinrai@users.noreply.github.com>
 *	-----
 *	@Last modified by: Nate Corcoran <CLDMV> (Shinrai@users.noreply.github.com)
 *	@Last modified time: 2026-03-04 21:03:45 -08:00 (1772687025)
 *	-----
 *	@Copyright: Copyright (c) 2013-2026 Catalyzed Motivation Inc. All rights reserved.
 */

/**
 * Custom UUID Timestamp Variant v2
 *
 * Subvariant 00 - Timestamp-based identification with milliseconds precision
 * Ultra-short alias: TB
 *
 * Bit Layout:
 ...
 */
export function v2(timestamp = null, entropy = null) {
	const buffer = Buffer.alloc(16);
	const version = 2;

	// Use current time if timestamp not provided (milliseconds precision)
	let timestampValue;
	if (timestamp === undefined || timestamp === null) {
		timestampValue = Date.now(); // milliseconds
...
/**
 * Alias for v2 - TB (Timestamp B - milliseconds precision)
 */
export const tb = v2;
 ...
 * @param {number} timestampValue - Timestamp value in milliseconds
 * @private
 */
